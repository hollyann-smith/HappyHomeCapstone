...
export default function Home() {
  return (
    <div className="flex flex-wrap grid-cols-2 gap-4 place-content-center content-center justify-center mt-40">
      <div className="relative bg-white border shadow-sm rounded-3xl w-96 h-96 dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7] max-w-md mx-3 my-3">
